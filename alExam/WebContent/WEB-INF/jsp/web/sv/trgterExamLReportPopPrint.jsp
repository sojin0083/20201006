...
<script type="text/javascript">
	...
	var P_R_NUMBER = "${R_NUMBER}";
	var P_EXAM_NO  = "${EXAM_NO}";	
	var P_EXAM_SN  = "${EXAM_SN}";	 
	...
	function fn_rsTrgt(data){
		...
		if(rsTrgt != null || rsTrgt != ''){
			...
			//$("#textAreaComment").text(rsTrgt.EXAM_OPIN);
			$('#textAreaComment').html(rsTrgt.EXAM_OPIN.split('&lt;br/&gt;').join("<br/>"));
		}
	}
	...
	function saveComment(){		
		...
		if(isNullToString(textAreaComment)!=""){
			if(confirm("저장 하시겠습니까?")){
				cfn.ajax({
					  "url"			:	"/sv/updateTrgterExamLReportComment.do" 
					, "data"		:	{
										  "EXAM_OPIN"		: $ ("#textAreaComment").val()
	 									, "EXAM_NO"		: $("#EXAM_NO").val()
	...
	<div class="page">
		<div class="subpage">
			...
			<table class="table_type print topb mt15">
				<tr>
					<td scope="col" id="textAreaComment"></th>
				</tr>
			</table>
		</div>
	</div>
