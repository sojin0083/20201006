...
var s_rmkanswer = new Array();
	...
	function pointSearch(){
		...
		cfn.ajax({
			  "url"			:	"/sv/trgterExamLResultDtlsPoint.do"
			, "data"		:	{
									"R_NUMBER"	:r_number
								  , "EXAM_NO"	:exam_no
								  , "EXAM_DIV"	:exam_div
	...
	//점수 총 점수 및 세부 점수 수정 함수
	function trgterExamPointUpd(){
		var answerCdUpd="";
		var answerCdDtlsUpd="";
		var answerUpd ="";
		var rmkanswerUpd="";
	...
	function drawListSucc2(data){  //SLINDA 그리기 
		// 			controllsize=data.examItemNm.length;
					...
					userTb.append("<li><h2>항목별 세부정보</h2></li>");
					userTb.append("<li><a href='#pop_new_input' id='btn_reset' class='btn_all col01' style='margin-right: 10px;'>원점수 조회</a>");
					userTb.append("<a href='#pop_text_in' id='' class='btn_all btn_upd' style='margin-right: 10px;'>점수 수정</a>");
...
<div class="btnright">
	<a href="/alExam/pageNavi.do?menuCd=NSV110" class="btn_all col01 btn_return">목록</a>
</div>
	<section class="">
		<h2>인적사항</h2>
...
<section class="mt35 selectListinfo2">
	<ul class="title_align">
		...
		<li><a href="#" class="btn_all col01" onclick="setMmsePoint('reset');">원점수 조회</a> <a href="#" class="btn_all" onclick="updateMmsePoint();">점수 수정</a></li>
	</ul>
